...
function prod() {
  ...
  gulp.task('js', function () {
    return gulp.src(Config.js.src).pipe(jshint.reporter('default')).pipe(gulp.dest(Config.js.dist)).pipe(rename({
      suffix: '.min'
  ...
  gulp.task('js-concat', function () {
    return gulp.src(Config.js.src).pipe(jshint.reporter('default')).pipe(concat(Config.js.build_name)).pipe(gulp.dest(Config.js.dist)).pipe(rename({
      suffix: '.min'
    })).pipe(uglify()).pipe(gulp.dest(Config.js.dist));
  });
  /**
  ...
  gulp.task('build', ['html', 'css', 'js', 'assets', 'images','less']);
}
module.exports = prod;